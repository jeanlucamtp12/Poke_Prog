...
<body>
    ...
    <div class="tela">
        ...
        <div class="caixaRotom">
            ...
            <img id="rotom" class="rotom" src="../img/funcoes/cortador_rotom.png" onclick="iniciarCriacao('cortador')"></img>
            <img id="rotom" class="rotom" src="../img/funcoes/forno_rotom.png" onclick="iniciarCriacao('forno')"></img>
            <img id="rotom" class="rotom" src="../img/funcoes/lavadeira_rotom.png" onclick="iniciarCriacao('lavadeira')"></img>
            <img id="rotom" class="rotom" src="../img/funcoes/ventilador_rotom.png" onclick="iniciarCriacao('ventilador')"></img>
            <img id="rotom" class="rotom" src="../img/funcoes/geladeira_rotom.png" onclick="iniciarCriacao('geladeira')"></img>

        </div><br></br>



        <div class="caixaItens" draggable="true">
        ...
        <div class="caixaResposta" ondragover="areaSoltar(event)" ondrop="soltarElemento(event)">
