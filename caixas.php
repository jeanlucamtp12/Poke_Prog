<script>
    ...
    const mapearUnowm = (unowm) => {
        ...
        const cont = document.querySelectorAll("#aU, #bU, #cU, #áU, #eU, #fU, #gU, #ãU ,#iU,#éU, #íU , #lU, #mU , #nU , #oU , #pU, #qU, #rU, #sU,  #tU, #uU, #vU, #wU, #xU, #yU, #zU, #çU, #úU");
...
<body>
    ...
    <div class="tamanhoTela">
        ...
        <div class="teclado">
            ...
            <div class="caixaTeclado">
                <h6>?</h6>
                <img class="circles" id="çU" src="./img/unowns/ó.gif" onclick="mapearUnowm('çU')" ;>
            </div>
            <div class="caixaTeclado">
                <h6>!</h6>
        ...
        <div class="caixaResposta">
            <span id="a"></span> <span id="b"></span> <span id="c"> </span> <span id="á"></span> <span id="e"></span><span id="f"></span><span id="g"></span> <span id="ã"></span> <span id="i"></span> <span id="é"></span> <span id="í"></span> <span id="l"></span> <span id="m"></span> <span id="n"></span> <span id="o"></span><span id="p"></span><span id="q"></span> <span id="r"></span> <span id="s"></span> <span id="t"></span><span id="u"></span><span id="v"></span> <span id="w"></span> <span id="x"></span> <span id="y"></span><span id="z"></span><span id="çU"></span> <span id="úU"></span>
        </div>
        ...
        <div class="blocoInicial">
            <img class="inicial" src="./img/bonus/1.png" alt="Ajuda" title="Ajuda" onclick="exibeAjuda()" style="cursor:pointer">
            <h2 id="ajuda" style="display:none">Se vira gay</h3>
        </div>
